 ...
 *     `TransactionContext`;
 *   - repository handles are bound to the section's lifetime and are
 *     permanently revoked when it closes — a stale handle never becomes
 *     usable again while a later section is open;
